...
const About = () => {
    ...
    return (
        ...
        >
            ...
            <div className="max-w-screen-lg mx-auto flex  items-start justify-start h-full px-4 md:flex-row w-full text-black">
                <div className="flex flex-col justify-center h-full">
                    <h2 className="text-4xl sm:text-6xl font-bold text-black">
                        About Us
                    </h2>
                    <div className="grid grid-cols-2 gap-4" >
                        <h3 className="py-6 text-centre text-sm font-light">
                        ...
                        <p></p>
                        <div className="py-6 text-centre text-sm font-light"><p>Get in Touch</p><p>email : momentmakers@gmail.com</p>
